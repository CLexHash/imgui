...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    if (!ImGui::Begin("Iris Engine", p_open, window_flags))
    {
    ...
    if (ImGui::BeginMenuBar())
    {
        ...
        if (ImGui::BeginMenu("Tools"))
        {
            ...
            ImGui::MenuItem("About Iris Engine", NULL, &show_app_about);
            ImGui::EndMenu();
        }
        ImGui::EndMenuBar();
    }

    ImGui::Text("Iris Engine says hello. (%s)", IMGUI_VERSION);
    ImGui::Spacing();

    IMGUI_DEMO_MARKER("Help");
    if (ImGui::CollapsingHeader("Help"))
    {
        ImGui::Text("ABOUT engine's GUI:");
    ...
    if (ImGui::CollapsingHeader("Configuration"))
    {
        ...
        if (ImGui::TreeNode("Configuration##2"))
        {
            ...
            ImGui::SameLine(); HelpMarker("Instruct  Gui to render a mouse cursor itself. Note that a mouse cursor rendered via your application GPU rendering path will feel more laggy than hardware cursor, but will be more in sync with your other visuals.\n\nSome desktop applications may use both kinds of cursors (e.g. enable software cursor only when resizing/dragging something).");
...
{
    if (!ImGui::Begin("About IrisEngine", p_open, ImGuiWindowFlags_AlwaysAutoResize))
    {
        ImGui::End();
        return;
    }
    IMGUI_DEMO_MARKER("Tools/About IrisEngine");
    ImGui::Text("GUI_VERSION %s", ImGui::GetVersion());
    ImGui::Separator();
    ImGui::Text("By Prakhar Pande and all Dear contributors.");
    ImGui::Text("IrisEngine is licensed under the Apache 2.0 License, see LICENSE for more information.");
    ...
    if (show_config_info)
    {
        ...
        ImGui::Text("Iris Engine %s (%d)", IMGUI_VERSION, IMGUI_VERSION_NUM);
        ImGui::Separator();
        ...
        ImGui::Text("define: IRIS_HAS_VIEWPORT");
#endif
#ifdef IMGUI_HAS_DOCK
        ImGui::Text("define: IRIS_HAS_DOCK");
#endif
        ImGui::Separator();
